...
export default function Page() {
  const [state, setState] = useState<FooterState>(DEFAULT_FOOTER_STATE);
  ...
  return <AppShell contentOverflow="hidden"><PlaygroundLayout title="Footer Studio" controls={controls} preview={output} /></AppShell>;
}
